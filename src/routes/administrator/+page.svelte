	...
	<div class="w-full md:max-w-2xl">
		...
		<form class="w-full" on:submit|preventDefault={handleSubmit}>
			...
			<div name="question" class="mt-10 mx-5 md:ml-10">
				...
				<div class="w-full flex flex-col">
					<input
						...
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c1">Rector</label>
					<input type="radio" id="q1c2" name="q1c" value="Vice-Rector" bind:group={q1c} />
					<label class="w-full md:w-fit mb-2 px-5" for="q1c2">Vice-Rector</label>
					<input type="radio" id="q1c3" name="q1c" value="Dean" bind:group={q1c} />
					<label class="w-full md:w-fit mb-2 px-5" for="q1c3">Dean</label>
					<input type="radio" id="q1c4" name="q1c" value="Vice-Dean" bind:group={q1c} />
					<label class="w-full md:w-fit mb-2 px-5" for="q1c4">Vice-Dean</label>
					<input
						type="radio"
						id="q1c5"
						name="q1c"
						value="Director of an Institute"
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c5">Director of an Institute</label>
					<input
						type="radio"
						id="q1c6"
						name="q1c"
						value="Deputy Director of an Institute"
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c6">Deputy Director of an Institute</label
					>
					<input type="radio" id="q1c7" name="q1c" value="Head of Department" bind:group={q1c} />
					<label class="w-full md:w-fit mb-2 px-5" for="q1c7">Head of Department</label>
					<input type="radio" id="q1c8" name="q1c" value="Education Director" bind:group={q1c} />
					<label class="w-full md:w-fit mb-2 px-5" for="q1c8">Education Director</label>
					<input type="radio" id="q1c9" name="q1c" value="Programme Director" bind:group={q1c} />
					<label class="w-full md:w-fit mb-2 px-5" for="q1c9">Programme Director</label>
					<input
						type="radio"
						id="q1c10"
						name="q1c"
						value="Administrative Manager (Education)"
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c10"
						>Administrative Manager (Education)</label
					>
				</div>
			</div>
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				...
				<div class="flex flex-col">
					...
					<div class="flex justify-between">
						...
						<input id="q4b" placeholder="e.g. 3" type="number" bind:value={q4c} />
					</div>
					<div class="flex justify-between">
						<p for="q4b">Developing students` relevant skills for the labour market</p>
						<input id="q4b" placeholder="e.g. 4" type="number" bind:value={q4d} />
					</div>
					<div class="flex justify-between">
						<p for="q4b">Providing mentorship to students</p>
						<input id="q4b" placeholder="e.g. 5" type="number" bind:value={q4e} />
					</div>
					<div class="flex justify-between">
						<p for="q4b">Inspiring students</p>
						<input id="q4b" placeholder="e.g. 6" type="number" bind:value={q4f} />
					</div>
					<div class="flex justify-between">
						<p for="q4b">Building a sense of belonging and community</p>
						<input id="q4b" placeholder="e.g. 7" type="number" bind:value={q4g} />
					</div>
				</div>
			</div>
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				...
				<h2 class="text-xl font-bold">
					I have experience in promoting excellence in teaching or PhD supervising practices in my
					own function as a manager
				</h2>
				<p class="italic text-slate-500 mb-5">
					(Agreement: 1 Strongly Disagree 2 Disagree 3 Undecided 4 Agree 5 Strongly Agree)
				</p>
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				...
				<h2 class="text-xl font-bold">
					At my institution, the most important qualities of an excellent teacher are:
				</h2>
				<p class="italic text-slate-500 mb-5">
				...
				<div class="flex flex-col">
					<div class="flex justify-between">
						<p for="q6a">Having in-depth knowledge of the subject</p>
						<input
							class="border-b-4"
							id="q6a"
							placeholder="e.g. 1"
					...
					<div class="flex justify-between">
						<p for="q6b">An active research profile on the subject taught</p>
						<input id="q6b" placeholder="e.g. 2" type="number" bind:value={q6b} />
					</div>
					<div class="flex justify-between">
						<p for="q6c">Being a scholar of teaching and learning</p>
						<input id="q6c" placeholder="e.g. 3" type="number" bind:value={q6c} />
					</div>
					<div class="flex justify-between">
						<p for="q6d">Being an effective communicator</p>
						<input id="q6d" placeholder="e.g. 4" type="number" bind:value={q6d} />
					</div>
					<div class="flex justify-between">
						<p for="q6e">Being empathetic</p>
						<input id="q6e" placeholder="e.g. 5" type="number" bind:value={q6e} />
					</div>
					<div class="flex justify-between">
						<p for="q6f">Being confident</p>
						<input id="q6f" placeholder="e.g. 6" type="number" bind:value={q6f} />
					</div>
					<div class="flex justify-between">
						<p for="q6g">Being open-minded</p>
						<input id="q6g" placeholder="e.g. 7" type="number" bind:value={q6g} />
					</div>
					<div class="flex justify-between">
						<p for="q6h">Being organised</p>
						<input id="q6h" placeholder="e.g. 8" type="number" bind:value={q6h} />
					</div>
				</div>
			</div>
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				...
				<div class="flex flex-col">
					<div class="flex justify-between">
						<p for="q7a">Financial resources</p>
						<input id="q7a" placeholder="e.g. 1" type="number" bind:value={q7a} />
					</div>
					<div class="flex justify-between">
						<p for="q6b">Time allocation</p>
						<input id="q6b" placeholder="e.g. 2" type="number" bind:value={q7b} />
					</div>
					<div class="flex justify-between">
						<p for="q6c">Excellent facilities</p>
						<input id="q6c" placeholder="e.g. 3" type="number" bind:value={q7c} />
					</div>
					<div class="flex justify-between">
						<p for="q6d">Support from university management</p>
						<input id="q6d" placeholder="e.g. 4" type="number" bind:value={q7d} />
					</div>
					<div class="flex justify-between">
						<p for="q6e">Innovation and experimentation</p>
						<input id="q6e" placeholder="e.g. 5" type="number" bind:value={q7e} />
					</div>
					<div class="flex justify-between">
						<p for="q6f">Staff training</p>
						<input id="q6f" placeholder="e.g. 6" type="number" bind:value={q7f} />
					</div>
					<div class="flex justify-between">
						<p for="q6g">Feedback from students</p>
						<input id="q6g" placeholder="e.g. 7" type="number" bind:value={q7g} />
					</div>
					<div class="flex justify-between">
						<p for="q6h">Feedback from peers</p>
						<input id="q6h" placeholder="e.g. 8" type="number" bind:value={q7h} />
					</div>
					<div class="flex justify-between">
						<p for="q6h">Feedback from accreditation bodies/quality assurance bodies</p>
			...
			<div name="question" class="mt-10 mx-2 mr-10 md:ml-10">
				<h2 class="text-xl">How to build a supportive and excellent teaching environment</h2>
			...
			<div name="question" class="mt-10 mx-2 mr-10 md:ml-10">
				<h2 class="text-xl">How to promote, reward and facilitate excellent university teachers</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 mr-10 md:ml-10">
				<h2 class="text-xl">How to build a quality assurance system for excellent education</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">How to build a university teaching training programme from scratch</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">How to improve existing university teaching training programmes</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">
					How to develop an institution-wide strategy for education excellence
				</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">How to design and implement effective teaching awards</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">How to build incentive structures for promoting teaching excellence</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">Analytical tools for measuring and improving teaching excellence</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-5">
					<input type="radio" id="q13i1" name="q13i" value="1" bind:group={q13i} />
					<label for="q13i1">1</label>
					<input type="radio" id="q13i2" name="q13i" value="2" bind:group={q13i} />
					<label for="q13i2">2</label>
					<input type="radio" id="q13i3" name="q13i" value="3" bind:group={q13i} />
					<label for="q13i3">3</label>
					<input type="radio" id="q13i4" name="q13i" value="4" bind:group={q13i} />
					<label for="q13i4">4</label>
					<input type="radio" id="q13i5" name="q13i" value="5" bind:group={q13i} />
					<label for="q13i5">5</label>
				</div>
			</div>

			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">
					How to design effective and appropriate faculty evaluation systems on teaching excellence
				</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-5">
					<input type="radio" id="q13j1" name="q13j" value="1" bind:group={q13j} />
					<label for="q13j1">1</label>
					<input type="radio" id="q13j2" name="q13j" value="2" bind:group={q13j} />
					<label for="q13j2">2</label>
					<input type="radio" id="q13j3" name="q13j" value="3" bind:group={q13j} />
					<label for="q13j3">3</label>
					<input type="radio" id="q13j4" name="q13j" value="4" bind:group={q13j} />
					<label for="q13j4">4</label>
					<input type="radio" id="q13j5" name="q13j" value="5" bind:group={q13j} />
					<label for="q13j5">5</label>
				</div>
			</div>

			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">
					Best Practices from European Universities in the field of Teaching Excellence
				</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-5">
					<input type="radio" id="q13k1" name="q13k" value="1" bind:group={q13k} />
					<label for="q13k1">1</label>
					<input type="radio" id="q13k2" name="q13k" value="2" bind:group={q13k} />
					<label for="q13k2">2</label>
					<input type="radio" id="q13k3" name="q13k" value="3" bind:group={q13k} />
					<label for="q13k3">3</label>
					<input type="radio" id="q13k4" name="q13k" value="4" bind:group={q13k} />
					<label for="q13k4">4</label>
					<input type="radio" id="q13k5" name="q13k" value="5" bind:group={q13k} />
					<label for="q13k5">5</label>
				</div>
			</div>
