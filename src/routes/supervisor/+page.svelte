<script>
	...
	async function handleSubmit() {
		...
		fetch('https://sheet.best/api/sheets/8a267e1c-3bae-4693-b18a-f9ed9e29c7e4/tabs/Rawc', {
			method: 'POST',
			mode: 'cors',
			headers: {
		...
		<form class="w-full" on:submit|preventDefault={handleSubmit}>
			...
			<div name="question" class="mt-10 mx-5 md:ml-10">
				...
				<div class="w-full flex flex-col">
					<input
						...
						id="q1c1"
						name="q1c"
						value="Beginning PhD Supervisor (without any completed PhD candidates) "
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c1"
						>Beginning PhD Supervisor (without any completed PhD candidates)</label
					>
					<input
						type="radio"
						id="q1c2"
						name="q1c"
						value="Experienced PhD Supervisors (with 5 or more completed PhD Candidates)"
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c2"
						>Experienced PhD Supervisors (with 5 or more completed PhD Candidates)</label
					>
					<input
						type="radio"
						id="q1c3"
						name="q1c"
						value="Very Experienced PhD Supervisor (with 15 or more completed PhD candidates)"
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c3"
						>Very Experienced PhD Supervisor (with 15 or more completed PhD candidates)</label
					>
					<input
						type="radio"
						id="q1c4"
						name="q1c"
						value="Administrative Position related to PhD supervision"
						bind:group={q1c}
					/>
					<label class="w-full md:w-fit mb-2 px-5" for="q1c4"
						>Administrative Position related to PhD supervision</label
					>
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				...
				<div class="flex flex-row mr-10">
					...
					<input type="radio" id="q123" name="q12" value="3" bind:group={q12} />
					<label for="q123">3</label>
					<input type="radio" id="q124" name="q12" value="4" bind:group={q12} />
					<label for="q124">4</label>
					<input type="radio" id="q125" name="q12" value="5" bind:group={q12} />
					<label for="q125">5</label>
				</div>
			</div>
			...
			<div name="question" class="mt-10 mx-2 mr-10 md:ml-10">
				<h2 class="text-xl">How to supervise PhD candidates: A comprehensive Beginners Guide</h2>
			...
			<div name="question" class="mt-10 mx-2 mr-10 md:ml-10">
				<h2 class="text-xl">Excellent PhD Supervision and Mentoring: Core Skills and Techniques</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 mr-10 md:ml-10">
				<h2 class="text-xl">
					Cross-cultural Communication and supervising International PhD Candidates
				</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">
					How to support PhD Candidates with Well-being and Mental health issues
				</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">Techniques for guiding “difficult” PhD Candidates to completion</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">Best Practices from Excellent European PhD Supervisors</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
			...
			<div name="question" class="mt-10 mx-2 md:ml-10">
				<h2 class="text-xl">Training PhD Candidates in Transferrable Skills</h2>
				<p class="italic text-slate-500 mb-5">(Agreement: 1 Not Beneficial 5 Very Beneficial)</p>
				<div class="flex flex-row mr-10">
